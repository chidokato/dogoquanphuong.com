                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea rows="3" name="content" class="form-control ckeditor">{{ isset($data) ? $data->content : '' }}</textarea>
                        </div>
                    </div>
                    <!-- <div class="col-md-12">
                        <div class="tab">
                            <button type="button" class="tablinks active" onclick="openCity(event, 'content')">Nội dung chi tết</button>
                            <button type="button" class="tablinks " onclick="openCity(event, 'London')">Thông số kỹ thuật</button>
                        </div>
                        ...
                        <div id="London" class="tabcontent">
                            <textarea name="detail" class="form-control ckeditor1" id="ckeditor1">{{ isset($data) ? $data->detail : '' }}</textarea>
                        </div>
                    </div> -->
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select name='category_id' class="form-control select2" >
                        ...
                        <option <?php //if(isset($data) && in_array($val->id, explode(',',$data->category_id))){echo 'selected';} ?> value="{{$val->id}}">{{$val->name}}</option>
                        @endforeach
                    </select> -->
                    <!-- <select name='category_sku[]' class="form-control select2" >
                        <option value="">-- Select --</option>
                        @foreach($category as $val)
                    ...
                    <div class="category">
                        ...
                        <label> {{$val->name}} <input required="" <?php //if(isset($data) && $data->category_id == $val->id){echo "checked";} ?> type="radio" name="category_id" value="{{$val->id}}"></label>
                    </div>
                    @endforeach
                    <style type="text/css">
